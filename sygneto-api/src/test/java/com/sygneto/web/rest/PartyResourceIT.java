    ...
    *//**
    ...
    public void getAllParties() throws Exception {
        ...
        restPartyMockMvc.perform(get("/api/parties?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(party.getPartyId().toString())));
    }
    ...
    public void getParty() throws Exception {
        ...
        // Get the party
        restPartyMockMvc.perform(get("/api/parties/{id}", party.getPartyId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(party.getPartyId().toString()));
    }
    ...
    public void updateParty() throws Exception {
        ...
        // Update the party
        Object updatedParty = partyRepository.findByPartyId(party.getPartyId());
    ...
    public void deleteParty() throws Exception {
        ...
        // Delete the party
        restPartyMockMvc.perform(delete("/api/parties/{id}", party.getPartyId())
