...
public class LabelResourceIntTest {/*
    ...
    *//**
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getKey()).isEqualTo(DEFAULT_KEY);
        assertThat(testLabel.getCondition()).isEqualTo(DEFAULT_CONDITION);
    ...
    public void updateLabel() throws Exception {
        ...
        Label testLabel = labelList.get(labelList.size() - 1);
        assertThat(testLabel.getKey()).isEqualTo(UPDATED_KEY);
        assertThat(testLabel.getCondition()).isEqualTo(UPDATED_CONDITION);
