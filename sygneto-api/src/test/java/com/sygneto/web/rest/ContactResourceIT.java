...
public class ContactResourceIT {
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(contact.getContactId().intValue())));
    }
    ...
    public void getContact() throws Exception {
        ...
        // Get the contact
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getContactId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(contact.getContactId().intValue()));
    }
    ...
    public void updateContact() throws Exception {
        ...
        // Update the contact
        Contact updatedContact = contactRepository.findById(contact.getContactId()).get();
    ...
    public void deleteContact() throws Exception {
        ...
        // Delete the contact
        restContactMockMvc.perform(delete("/api/contacts/{id}", contact.getContactId())
    ...
    public void equalsVerifier() throws Exception {
        ...
        contact2.setContactId(contact1.getContactId());
        assertThat(contact1).isEqualTo(contact2);
        contact2.setContactId(2L);
        assertThat(contact1).isNotEqualTo(contact2);
        contact1.setContactId(null);
        assertThat(contact1).isNotEqualTo(contact2);
    }
}
