package com.sygneto.config.timezone;

import com.sygneto.SygnetoApiApp;
import com.sygneto.repository.timezone.DateTimeWrapper;
import com.sygneto.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM sygneto_date_time_wrapper where id=%d", fieldName, id);
    }
