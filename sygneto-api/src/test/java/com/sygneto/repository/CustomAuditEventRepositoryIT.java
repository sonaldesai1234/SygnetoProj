...
import com.sygneto.config.audit.AuditEventConverter;
import com.sygneto.domain.ItemInward;
import com.sygneto.domain.Party;
import com.sygneto.domain.PersistentAuditEvent;
...
import static com.sygneto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    @Autowired
    ItemInwardRepository itemInwardRepository;
    @Autowired
